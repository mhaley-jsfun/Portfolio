    ...
    <div className="grid grid-cols-2 items-center gap-7">
      ...
      <div className="col-span-2 lg:col-span-1">
        ...
        >
          ...
          <div>
            <p className="text-lg">
              Full Stack software engineer, highly experienced in many aspects
              of web development - from technical architecture & implementation,
              to cross-functional project planning, to hiring & mentoring teams.
              I create and work on web applications often because I sincerely
              enjoy software development. I love learning how to use new
              frameworks, and I enjoy strengthening my skills in technologies
              with which I am already competent. My continued success is rooted
              in my ability to positively contribute to the project development
              lifecycle, including requirements gathering, testing, and
              validation actions. With a proven track record in fast-paced,
